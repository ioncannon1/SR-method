...
void place_and_fit_spots_origin(const std::vector<CVD::Image<float> >& ims, const std::vector<CVD::ImageRef>& region, const CVD::Image<double>& log_ratios, std::string save_spots_file, FitSpotsGraphics& g, const std::string&s="");
void place_and_fit_spots_origin(const std::vector<CVD::Image<float> >& ims, const std::vector<CVD::ImageRef>& region, const CVD::Image<double>& log_ratios, std::ofstream& save_spots_file, FitSpotsGraphics& g, UserInterfaceCallback&, const std::string&s="");
